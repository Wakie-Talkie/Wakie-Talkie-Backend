...
urlpatterns = [
    ...
    path('ai-users/get-sample-audio/', AISampleAudio.as_view(), name='get-sample-audio'),
    path('ai-users/get-sample-audio/<int:pk>', AISampleAudio.as_view(), name='get-sample-audio-pk'),
